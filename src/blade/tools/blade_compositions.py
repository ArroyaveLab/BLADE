...
For HEDB diborides, transition metals serve as the primary pool and
rare-earth elements as the secondary pool. Any element sets work for other
crystal systems with variable sublattice sites.
    ...
    def __init__(
        ...
        Args:
            primary_elements (list[str]): Primary element symbols for the
                ...
                metals for HEDB diborides).
            secondary_elements (list[str]): Secondary element symbols
                (e.g., ``["Y", "La"]``; rare-earth elements for HEDB diborides).
